                ...
                <div class="card-body">
                    ...
                    <form method='POST' action="{{route('danhmuc.update',[$danhmuc->id])}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tendanhmuc" value="{{$danhmuc->tendanhmuc}}" onkeyup="ChangeToSlug();" id="slug" aria-describedby="emailHelp" placeholder="Tên danh mục...">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{$danhmuc->mota}}" name="mota" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nội dung danh mục...">
                        </div>
                        <div class="mb-3">
